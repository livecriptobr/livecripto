...
import { Loader2, Wallet, ArrowUpRight, Plus, Trash2 } from 'lucide-react'
      ...
      <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-800 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            <p className="text-xs text-zinc-500 mt-1">Minimo: {formatCurrency(limits?.minWithdraw ?? 1000)}</p>
          </div>
          <div>
            <label className="block text-sm text-zinc-400 mb-2">Conta de destino</label>
        ...
        <button
          ...
          className="bg-green-600 hover:bg-green-700 disabled:opacity-50 px-6 py-2.5 rounded-lg flex items-center gap-2 transition-colors font-medium"
        >
